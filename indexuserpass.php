...
//pobranie wynikow zapytania do tablicy
 ...
 //jezeli nie wystepuje w bazie
    ...
    if($c==10) {
        ...
        $c=1;//echo ' --------------- '.$c;
        echo '<br />U�YTKOWNIK ZOSTA� ZABLOKOWANY - ZBYT WIELE NIEUDANYCH PR�B LOGOWANIA, W CELU ODBLOKOWANIA SKONTAKTUJ SI� Z ADMINISTRATOREM SYSTEMU';
    }
    //jezeli licznik jeszcze nie osiagnal 10 prob to wyswietla si� strona logowania ponownie
    else{
