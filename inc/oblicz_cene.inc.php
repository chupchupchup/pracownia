...
//funkcja obliczajaca cen� zlecenia
...
//FUNKCJA OBLICZAJ�CA CEN� DLA TABELI WKLADY K-K
...
//FUNKCJA OBLICZAJ�CA CEN� DLA TABELI PORCELANA KORONA LICOWANA NA METALU
...
//FUNKCJA OBLICZAJ�CA CEN� DLA TABELI PORCELANA KORONA PE�NOCERAMICZNA
...
//FUNKCJA OBLICZAJ�CA CEN� DLA TABELI PORCELANA INLAY ONLAY LIC�WKA
...
//FUNKCJA OBLICZAJ�CA CEN� DLA TABELI PORCELANA IMPLANTY
function c_implanty($tablica_cen,$tablica_zlecenia) {
  ...
  foreach($tablica_zlecenia as $klucz => $wartosc){
    ...
    elseif($tablica_zlecenia[$klucz]=='prz�s�o'){
      //echo $tablica_zlecenia[$klucz].'<br>';
      $c_pom=$c_pom+$tablica_cen['prz�s�o '.$tablica_zlecenia['material']]*$tablica_zlecenia['liczba_przeslo'];
      //echo $c_pom;
    }
...
//FUNKCJA OBLICZAJ�CA CEN� DLA TABELI PORCELANA KORONY INNE
function c_korony_inne($tablica_cen,$tablica_zlecenia) {
  ...
  foreach($tablica_zlecenia as $klucz => $wartosc){
    ...
    elseif($tablica_zlecenia[$klucz]=='w��kno szklane'){
      $c_pom=$c_pom+$tablica_cen['w��kno szklane']*$tablica_zlecenia['liczba_wlokno_szklane'];
    }
...
/*
//FUNKCJA OBLICZAJ�CA CEN� DLA TABELI PORCELANA NAPRAWA
...
//FUNKCJA OBLICZAJ�CA CEN� DLA TABELI PROTEZA SZKIELET SZYNOPROTEZA
function c_szkielet_szynoproteza($tablica_cen,$tablica_zlecenia) {
  ...
  foreach($tablica_zlecenia as $klucz => $wartosc){
    ...
    elseif($tablica_zlecenia[$klucz]=='z�by ivoclar'){
      $c_pom=$c_pom+$tablica_cen['z�by ivoclar']*$tablica_zlecenia['liczba_zeby_ivoclar'];
    }
...
//FUNKCJA OBLICZAJ�CA CEN� DLA TABELI PROTEZA CA�KOWITA
...
//FUNKCJA OBLICZAJ�CA CEN� DLA TABELI PROTEZA CZʦCIOWA
...
//FUNKCJA OBLICZAJ�CA CEN� DLA TABELI PROTEZA SZYNY
...
//FUNKCJA OBLICZAJ�CA CEN� DLA TABELI PROTEZA NAPRAWA
function c_proteza_naprawa($tablica_cen,$tablica_zlecenia) {
  ...
  foreach($tablica_zlecenia as $klucz => $wartosc){
    ...
    elseif($tablica_zlecenia[$klucz]=='dostawienie z�ba' && $tablica_zlecenia['dostawienie_zeba_ilosc']>0){
        $c_pom=$c_pom+$tablica_cen['dostawienie z�ba']*$tablica_zlecenia['dostawienie_zeba_ilosc']+25;
    }
