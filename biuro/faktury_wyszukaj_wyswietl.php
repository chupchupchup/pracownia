  ...
  if($wyszukiwanie=='form'){
    ...
    if($_REQUEST['status']=='dowolny'){
      ...
      elseif( $_REQUEST['status']=='anulowana' ){
        ...
        $status_sql = $_SESSION['status_sql'];                      //z ostatnich wynikow wyszukiwania ze zmiennej sesyjnej ustawi� wartosci
      }                                                             //wyszukiwanych p�l - tak samo ponizej
    }
...
//echo $sql_sum;
  ...
  elseif($wyszukiwanie=='ostatnie'){
    ...
    $t_opis=array('NR FV'=>'80','STATUS'=>'100','WARTO�� <br />NETTO'=>'120','WARTO�� <br />BRUTTO'=>'120','ZAP�ACONO <br />BRUTTO'=>'110','DATA <br />FV'=>'60','SPOS�B <br />ZAP�ATY'=>'100','TERMIN <br />ZAP�ATY'=>'100', 'KLIENT'=>'120');
