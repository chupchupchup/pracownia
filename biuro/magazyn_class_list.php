...
class Dane
{
 ...
 // zwraca list� atrybutow oddzielonych przecinkiem
 function pobierzListeAtrybutow()
 {
 return join(', ', array_keys($this->dane));
 }

 // zwraca list� warto�ci oddzielonych przecinkiem
...
class Magazyn
{
 ...
 function pobierz(Dane $szukamy, $strona, $czyData, $dataOd, $dataDo)
 {
   ...
   $wyszukaj_template_table_menu=array('Nazwa'=>'200','Data'=>'100','Ilo�� ca�kowita'=>'150','Ilo�� pozosta�a'=>'150','Cena zakupu'=>'100','Wpisuj�cy'=>'130');
   ...
   //Liczba stron, u�ycie ceil - zaokr�glenie w g�r�, w celu zapewnienia, �e �adna strona si� nie straci
   //echo $r[0].'<br>';
   $pages = ceil($r[0]/15);
   $offset=$strona*15;
...
// POBIERZ Z PODMAGAZYNU
 ...
 {
   //include('./inc/table_menu_arrays.inc.php');
   $wyszukaj_template_table_menu=array('Nazwa'=>'200','Ilo��'=>'150','Cena materia�u'=>'150','Wykorzystuj�cy'=>'130','Data'=>'100');
