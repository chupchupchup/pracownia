...
//------------------------------------------------------------------------------------------------------------------
//Zmienne
    $_SESSION['sposob_zaplaty']=$_POST['sposob_zaplaty'];

    $_SESSION['termin_zaplaty']=$_POST['termin_zaplaty'];

    $_SESSION['konto_bankowe']=$_POST['konto_bankowe'];

    $_SESSION['data_faktury']=$_POST['data_faktury'];

    $_SESSION['fv_miesiac']=$_POST['fv_miesiac'];

    $_SESSION['fv_rok']=$_POST['fv_rok'];

    $_SESSION['czy_wystawic_fakture']=$_POST['czy_wystawic_fakture'];
	
    $_SESSION['uwagi_fv']=$_POST['uwagi_fv'];


    $sprzedawca_nazwa='Uslugi Protetyczne Jerzy Andryskowski';
    $sprzedawca_adres='80-246 Gdansk, ul.Jaskowa Dolina 9/1';
...
//------------------------------------------------------------------------------------------------------------------
    ...
    $smarty->assign('tab_suma', $_SESSION['tab_suma']);
                           //'PKWiU'=>'50',
    $t_opis=array('l.p.'=>'20','Nazwa towaru/us3ugi'=>'150','Ilo턠'=>'60', 'jm'=>'50', 'Cena <br />netto'=>'80', 'Stawka <br />VAT %'=>'80','Warto턠 <br />netto'=>'80','Warto턠 <br />VAT'=>'80','Warto턠 <br />brutto'=>'80');
...
//    $smarty->display('faktury_wydruk.tpl');
    ...
    $smarty->assign('plik', 'faktury_wydruk_popup.tpl');
