...
function spr_zlecenie($tabela){
 ...
 $sql_spr_tab="SELECT * FROM zlecenieinfo WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='".$tabela."' ";
 //echo $sql_spr_tab.'<br />';
   $wynik_spr_tab=myquery($sql_spr_tab);
   if(mysql_num_rows($wynik_spr_tab)>0){
     $arr_spr_tab = mysql_fetch_assoc($wynik_spr_tab);
	 $sql_del_poprzedni_tab="DELETE FROM zlecenieinfo WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='".$tabela."' ";// AND datawpisania='".$arr_spr_tab['datawpisania']."'
     myquery($sql_del_poprzedni_tab);
   }

   //dodawanie info o zleceniu do bazy
   $sql="INSERT INTO zlecenieinfo (idzlecenianr,idzleceniapoz,datawpisania,zwrotzleceniadata,zwrotzleceniagodz,pacjent,idzewnetrzne,kategoria,kod_kreskowy,zlecenie,pracownikid) 
                VALUES ('".$idzlecenianr."','".$idzleceniapoz."','".$datawpisania."','".$zwrotzleceniadata."','".$zwrotzleceniagodz."','".$pacjent."',
				        '".$idzewnetrzny."','".$tabela."','".$kod_kreskowy."','".$zlecenie."','".$arr_spr_tab['pracownikid']."') ";
   myquery($sql);
 }
}
...
if($_SESSION['form_tab']['zakladka']=="porcelana_1"){
 ...
 //zapisanie do tabicy identyfikatorow tablic w bazie do kt�rych zostaly zapisane dane �eby na koncu
 //latwiej je by�o wyswietlic w podsumowaniu
 $_SESSION['zakladka'][]="porcelana_wkladykk";

 //usuwanie poprzedniego zlecenia z bazy
 $sql_spr="SELECT * FROM zlecenieinfo WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='porcelana_wkladykk' ";
// echo $sql_spr.'<br />';
   $wynik_spr=myquery($sql_spr);
   if(mysql_num_rows($wynik_spr)>0){
     $arr_spr = mysql_fetch_assoc($wynik_spr);
	 $sql_del_poprzedni="DELETE FROM porcelana_wkladykk WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='".$kategoria."' ";// AND datawpisania='".$arr_spr['datawpisania']."'
     myquery($sql_del_poprzedni);
   }
...
// $przymiarka_kompozytu = czysc_zmienne_formularza($_SESSION['form_tab']['przymiarka_kompozytu']);
 ...
 //usuwanie poprzedniego zlecenia z bazy
 $sql_spr="SELECT * FROM zlecenieinfo WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='porcelana_korona_licowana_na_metalu' ";
// echo $sql_spr.'<br />';
   $wynik_spr=myquery($sql_spr);
   if(mysql_num_rows($wynik_spr)>0){
     $arr_spr = mysql_fetch_assoc($wynik_spr);
	 $sql_del_poprzedni="DELETE FROM porcelana_korona_licowana_na_metalu WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='".$kategoria."' ";// AND datawpisania='".$arr_spr['datawpisania']."'
     myquery($sql_del_poprzedni);
   }
...
elseif($_SESSION['form_tab']['zakladka']=="porcelana_3"){
 ...
 //usuwanie poprzedniego zlecenia z bazy
 $sql_spr="SELECT * FROM zlecenieinfo WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='porcelana_korona_pelnoceramiczna' ";
// echo $sql_spr.'<br />';
   $wynik_spr=myquery($sql_spr);
   if(mysql_num_rows($wynik_spr)>0){
     $arr_spr = mysql_fetch_assoc($wynik_spr);
	 $sql_del_poprzedni="DELETE FROM porcelana_korona_pelnoceramiczna WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='".$kategoria."' ";// AND datawpisania='".$arr_spr['datawpisania']."'
     myquery($sql_del_poprzedni);
   }
...
elseif($_SESSION['form_tab']['zakladka']=="porcelana_4"){
 ...
 //dodatkowe zmienne
 $datawpisania = $_SESSION['datawpisania'];
 $kategoria = "Porcelana Inlay/Onlay/Lic�wka";
 ...
 //usuwanie poprzedniego zlecenia z bazy
 $sql_spr="SELECT * FROM zlecenieinfo WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='porcelana_inlay_onlay_licowka' ";
// echo $sql_spr.'<br />';
   $wynik_spr=myquery($sql_spr);
   if(mysql_num_rows($wynik_spr)>0){
     $arr_spr = mysql_fetch_assoc($wynik_spr);
	 $sql_del_poprzedni="DELETE FROM porcelana_inlay_onlay_licowka WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='".$kategoria."' ";// AND datawpisania='".$arr_spr['datawpisania']."'
     myquery($sql_del_poprzedni);
   }
...
elseif($_SESSION['form_tab']['zakladka']=="porcelana_5"){
 ...
 //usuwanie poprzedniego zlecenia z bazy
 $sql_spr="SELECT * FROM zlecenieinfo WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='porcelana_implanty' ";
// echo $sql_spr.'<br />';
   $wynik_spr=myquery($sql_spr);
   if(mysql_num_rows($wynik_spr)>0){
     $arr_spr = mysql_fetch_assoc($wynik_spr);
	 $sql_del_poprzedni="DELETE FROM porcelana_implanty WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='".$kategoria."' ";// AND datawpisania='".$arr_spr['datawpisania']."'
     myquery($sql_del_poprzedni);
   }
 ...
 $sql="INSERT INTO porcelana_implanty ( kategoria , idzlecenianr , idzleceniapoz , datawpisania , wpisujacy ,
			material, rodzajkolornika , kolor, korona_implant, liczba_korona_implant, przeslo, liczba_przeslo,
                        lyzka,wzornik, przymiarka, surowa, gotowa, malowanie, dobor_koloru,
                        poprawka, elementy, zakupione_cena, zeby  )
       VALUES (
	      '".$kategoria."','".$idzlecenianr."','".$idzleceniapoz."','".$datawpisania."','".$idusera."',
              ...
              '".$malowanie."','".$dobor_koloru."','".$poprawka."','".$elementy."','".$zakupione_cena."','".$zeby."'
	      )";
...
elseif($_SESSION['form_tab']['zakladka']=="porcelana_7"){
 ...
 //usuwanie poprzedniego zlecenia z bazy
 $sql_spr="SELECT * FROM zlecenieinfo WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='porcelana_korony_inne' ";
// echo $sql_spr.'<br />';
   $wynik_spr=myquery($sql_spr);
   if(mysql_num_rows($wynik_spr)>0){
     $arr_spr = mysql_fetch_assoc($wynik_spr);
	 $sql_del_poprzedni="DELETE FROM porcelana_korony_inne WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='".$kategoria."' ";// AND datawpisania='".$arr_spr['datawpisania']."'
     myquery($sql_del_poprzedni);
   }
...
elseif($_SESSION['form_tab']['zakladka']=="proteza_1"){
 ...
 //usuwanie poprzedniego zlecenia z bazy
 $sql_spr="SELECT * FROM zlecenieinfo WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='proteza_szkielet_szynoproteza' ";
// echo $sql_spr.'<br />';
   $wynik_spr=myquery($sql_spr);
   if(mysql_num_rows($wynik_spr)>0){
     $arr_spr = mysql_fetch_assoc($wynik_spr);
	 $sql_del_poprzedni="DELETE FROM proteza_szkielet_szynoproteza WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='".$kategoria."' ";// AND datawpisania='".$arr_spr['datawpisania']."'
     myquery($sql_del_poprzedni);
   }
...
elseif($_SESSION['form_tab']['zakladka']=="proteza_2"){
 ...
 //usuwanie poprzedniego zlecenia z bazy
 $sql_spr="SELECT * FROM zlecenieinfo WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='proteza_calkowita' ";
// echo $sql_spr.'<br />';
   $wynik_spr=myquery($sql_spr);
   if(mysql_num_rows($wynik_spr)>0){
     $arr_spr = mysql_fetch_assoc($wynik_spr);
	 $sql_del_poprzedni="DELETE FROM proteza_calkowita WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='".$kategoria."' ";// AND datawpisania='".$arr_spr['datawpisania']."'
     myquery($sql_del_poprzedni);
   }
...
elseif($_SESSION['form_tab']['zakladka']=="proteza_3"){
 ...
 //usuwanie poprzedniego zlecenia z bazy
 $sql_spr="SELECT * FROM zlecenieinfo WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='proteza_czesciowa' ";
// echo $sql_spr.'<br />';
   $wynik_spr=myquery($sql_spr);
   if(mysql_num_rows($wynik_spr)>0){
     $arr_spr = mysql_fetch_assoc($wynik_spr);
	 $sql_del_poprzedni="DELETE FROM proteza_czesciowa WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='".$kategoria."' ";// AND datawpisania='".$arr_spr['datawpisania']."'
     myquery($sql_del_poprzedni);
   }
...
elseif($_SESSION['form_tab']['zakladka']=="proteza_4"){
 ...
 //usuwanie poprzedniego zlecenia z bazy
 $sql_spr="SELECT * FROM zlecenieinfo WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='proteza_szyny' ";
// echo $sql_spr.'<br />';
   $wynik_spr=myquery($sql_spr);
   if(mysql_num_rows($wynik_spr)>0){
     $arr_spr = mysql_fetch_assoc($wynik_spr);
	 $sql_del_poprzedni="DELETE FROM proteza_szyny WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='".$kategoria."' ";// AND datawpisania='".$arr_spr['datawpisania']."'
     myquery($sql_del_poprzedni);
   }
...
elseif($_SESSION['form_tab']['zakladka']=="proteza_5"){
 ...
 //usuwanie poprzedniego zlecenia z bazy
 $sql_spr="SELECT * FROM zlecenieinfo WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='proteza_naprawa' ";
// echo $sql_spr.'<br />';
   $wynik_spr=myquery($sql_spr);
   if(mysql_num_rows($wynik_spr)>0){
     $arr_spr = mysql_fetch_assoc($wynik_spr);
	 $sql_del_poprzedni="DELETE FROM proteza_naprawa WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='".$kategoria."' ";// AND datawpisania='".$arr_spr['datawpisania']."'
     myquery($sql_del_poprzedni);
   }
...
elseif($_SESSION['form_tab']['zakladka']=="proteza_6"){
 ...
 //usuwanie poprzedniego zlecenia z bazy
 $sql_spr="SELECT * FROM zlecenieinfo WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='proteza_prace_pomocnicze' ";
// echo $sql_spr.'<br />';
   $wynik_spr=myquery($sql_spr);
   if(mysql_num_rows($wynik_spr)>0){
     $arr_spr = mysql_fetch_assoc($wynik_spr);
	 $sql_del_poprzedni="DELETE FROM proteza_prace_pomocnicze WHERE idzlecenianr='".$idzlecenianr."' AND idzleceniapoz='".$idzleceniapoz."' AND kategoria='".$kategoria."' ";// AND datawpisania='".$arr_spr['datawpisania']."'
     myquery($sql_del_poprzedni);
   }
 ...
 $_SESSION['zakladka']=array_unique($_SESSION['zakladka']); //usuniecie duplikat�w kom�rek tabeli zapisywanych zlece�
