...
HISTORIA ROZLICZEÑ - <b><i>{$lekarz}</i></b><br><br>
...
<a style="color:white;" href="./biuro.php?strona=rozliczenia&lekarz={$lekarz}&archiwum=lekarz_pokaz&datarozliczenia={$tablica_wynikow[f][0]}&amp">
