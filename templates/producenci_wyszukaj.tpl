...
{if $lokalizacja=='dodaj_producenta'}
...
<a style="color:white;" href="./biuro.php?strona=glowna_producenci&wpis=edycja_producentaid={$tablica_wynikow[f][0]}&amp" target="_self">
...
{elseif $lokalizacja=='wyszukaj_producenta'}

{section name=f loop=$tablica_wynikow}
<tr onmouseover="this.style.background='#FFE3C7'" onmouseout="this.style.background='#ECECEC'" style="background:#ECECEC; margin-left:10px;margin-top:0px;margin-bottom:0px;height:22px; width:850px;">
<a style="color:white;" href="./biuro.php?strona=glowna_producenci&wpis=edycja_producenta&id={$tablica_wynikow[f][0]}&amp" target="_self">
  {assign var=v value=1}
  {foreach key=key item=item from=$tablica_wynikow[f]}
