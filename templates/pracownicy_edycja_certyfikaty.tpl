...
<form name="form" action="./biuro.php" method="post">
  ...
  <input type="hidden" name="wpis" value="usun_cert" />
  <input type="hidden" name="pracownikid" value="{$pracownikid}" />
  <input type="hidden" name="pracownicy_certyfikaty_id" value="{$pracownicy_certyfikaty_id}" />
...
<form name="form" action="./biuro.php" method="post">
  <input type="hidden" name="strona" value="glowna" />
  <input type="hidden" name="wpis" value="aktualizuj_cert" />
  <input type="hidden" name="pracownikid" value="{$pracownikid}" />
  <input type="hidden" name="pracownicy_certyfikaty_id" value="{$pracownicy_certyfikaty_id}" />

  <table class="tab" style="width:558px; ">
    <tr class="inputfr">
     <td style="width:80px; height:25px; font-size: 11px;">Data otrzymania cert: </td>
     <td style="height:25px; font-size: 11px;"><input type="text" class="inputf" name="data_otrzymania_cert" size="10" value="{$data_otrzymania_cert}"/> </td>
     <td>Certyfiat: </td>
     <td><textarea name="certyfikat" cols="30" rows="5">{$certyfikat}</textarea> </td>
    </tr>
  </table>
  <table class="tab" style="width:558px; ">
    <tr class="inputfr">
