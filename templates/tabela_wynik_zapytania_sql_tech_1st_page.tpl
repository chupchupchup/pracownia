...
<a style="color:white;" href="./pracownia.php?strona=zlecenia_tech/addform_3t.php&zlecenienr={$tablica_wynikow[f][0]}&kategoria={$tablica_wynikow[f][7]}&zleceniepoz={$tablica_wynikow[f][1]}&datawpisania={$tablica_wynikow[f][2]}&z_linku_bezposredniego=tak&amp" target="_self">
...
<tr style="line-height:2px;margin-top:0px;margin-left:10px;background:#FF9900;">
  {foreach key=key item=item from=$tablica_opisy}
    ...
    <td style="float:left;height:1px;width:{$item}px;text-align:center;" nowrap>&nbsp</td>
