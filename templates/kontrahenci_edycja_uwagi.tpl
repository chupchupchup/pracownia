...
<form name="form" action="./biuro.php" method="post">
  ...
  <input type="hidden" name="id_uwagi" value="{$id_uwagi}" />
...
<form name="form" action="./biuro.php" method="post">
  ...
  <table class="tab" style="width:558px; ">
    <tr class="inputfr">
     ...
     <td style="height:25px; font-size: 11px;"><input type="text" class="inputf" name="data_uwagi" size="10" align="left" value="{$data_uwagi}" /> </td>
     <td style="width:100px; height:25px; font-size: 11px;">Uwaga: </td>
     <td><textarea name="uwaga" cols="30" rows="2">{$uwaga}</textarea> </td>
    </tr>
  </table>
  <table class="tab" style="width:558px; ">
    <tr class="inputfr">
